            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4 mb-2">
                            <a class="btn btn-primary p-5 w-100" href="{{ url('/admin/userShowMessage/'.Auth::User()->id) }}">See Send Message</a>
                        </div>
                        <div class="col-4 mb-2">
                            <a class="btn btn-secondary p-5 w-100" href="{{ url('/admin/userReceiveMessage/'.Auth::User()->id) }}">See Receive Message</a>
                        </div>
                    </div>
                </div>
            </div>
